...
public class NacosAutoConfiguration {
    ...
    public RegisterService nacosRegisterService() {
        ...
        try {
            ...
            Constructor<?> constructor = nacosRegisterServiceClass.getConstructor(namingFactoryClass);
            return (RegisterService) constructor.newInstance(namingServiceInstance);
